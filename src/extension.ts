...
export function activate(context: vscode.ExtensionContext) {
    ...
    let disposable = vscode.commands.registerCommand('vietis-idt.helloWorld', () => {
        vscode.window.showInformationMessage('Hello from your React app extension!');
      });
      const command = 'vietis-idt.sayHello';
    ...
    context.subscriptions.push(
        ...
        vscode.commands.registerCommand('vietis-idt.showChatTopicList', () => {
